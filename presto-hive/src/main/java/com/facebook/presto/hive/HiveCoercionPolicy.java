        ...
        implements CoercionPolicy
{
    ...
    public boolean canCoerce(HiveType fromHiveType, HiveType toHiveType)
    {
        ...
        if (fromType instanceof VarcharType) {
            return toHiveType.equals(HIVE_BYTE) || toHiveType.equals(HIVE_SHORT) || toHiveType.equals(HIVE_INT) || toHiveType.equals(HIVE_LONG) || toHiveType.equals(HIVE_DOUBLE) || toHiveType.equals(HIVE_FLOAT);
        }
        if (toType instanceof VarcharType) {
            return fromHiveType.equals(HIVE_BYTE) || fromHiveType.equals(HIVE_SHORT) || fromHiveType.equals(HIVE_INT) || fromHiveType.equals(HIVE_LONG) || toHiveType.equals(HIVE_DOUBLE) || toHiveType.equals(HIVE_FLOAT);
        }
